...
namespace SharpNet.LightGBM
{
    public class Parameters
    {
        ...
        /// aliases: task_type
        /// </summary>
        public enum task_enum { train, predict, convert_model, refit };
        // ReSharper disable once MemberCanBePrivate.Global
        public task_enum task = task_enum.train;
        ...
        public enum objective_enum { regression, regression_l1, huber, fair, poisson, quantile, mape, gamma, tweedie, binary, multiclass, multiclassova, cross_entropy, cross_entropy_lambda, lambdarank, rank_xendcg }
        //aliases: objective_type, app, application, loss
        // ReSharper disable once MemberCanBePrivate.Global
        public objective_enum objective = objective_enum.regression;


        public enum boosting_enum { gbdt, rf, dart, goss }
        //gbdt:  traditional Gradient Boosting Decision Tree, aliases: gbrt
        //rf:    Random Forest, aliases: random_forest
        //dart:  Dropouts meet Multiple Additive Regression Trees
        //goss:  Gradient-based One-Side Sampling
        //Note: internally, LightGBM uses gbdt mode for the first 1 / learning_rate iterations
        public boosting_enum boosting = boosting_enum.gbdt;
        ...
        //aliases: device
        public enum device_type_enum {cpu,gpu}
        public device_type_enum device_type = device_type_enum.cpu;
        ...
        public string output_model = "LightGBM_model.txt";
        ...
        public int saved_feature_importance_type = 0;
        ...
        //< 0 means no limit
        public double histogram_pool_size = -1.0;
        ...
        public double bagging_fraction = 1.0;
        ...
        public double pos_bagging_fraction = 1.0;
        ...
        public double neg_bagging_fraction = 1.0;
        ...
        public int bagging_freq = 0;

        //random seed for bagging
        //aliases: bagging_fraction_seed
        public int bagging_seed = 3;
        ...
        public double linear_lambda = 0.0;

        //the minimal gain to perform split
        //can be used to speed up training
        // aliases: min_split_gain
        // constraints: min_gain_to_split >= 0.0
        public double min_gain_to_split = 0.0;
        ...
        public int min_data_per_group = 100;
        ...
        public int max_cat_threshold = 32;

        // used for the categorical features
        // L2 regularization in categorical split
        // constraints: cat_l2 >= 0.0
        public double cat_l2 = 10.0;

        // used for the categorical features
        // this can reduce the effect of noises in categorical features, especially for categories with few data
        // constraints: cat_smooth >= 0.0
        public double cat_smooth = 10.0;
        ...
        public int max_cat_to_onehot = 4;
        ...
        //public double monotone_penalty = 0.0;
        ...
        public int bin_construct_sample_cnt = 200000;

        //random seed for sampling data to construct histogram bins
        //aliases: data_seed
        public int data_random_seed = 1;
        ...
        public int start_iteration_predict = 0;
        ...
        public string prediction_result = "LightGBM_predict_result.txt";
        #endregion
        ...
        //public string convert_model = "gbdt_prediction.cpp";
        ...
        public int objective_seed = 5;

        // used only in multi-class classification application
        // aliases: num_classes
        // constraints: num_class > 0
        public int num_class = 1;
        ...
        public double poisson_max_delta_step = 0.7;
        ...
        public double tweedie_variance_power = 1.5;
        ...
        //public int lambdarank_truncation_level = 30;
        ...
        //public string eval_at = "1,2,3,4,5"; 
        ...
        public int multi_error_top_k = 1;
        ...
        //public int local_listen_port = 12400;
