...
#pragma warning restore 649
        ...
        public override void ForwardPropagation(List<Tensor> allX, Tensor y1, bool isTraining)
        {
            ...
            for (int t = 0; t < _timeSteps_x; ++t)
            {
                ...
                y_buffer1.ActivationForward(cudnnActivationMode_t.CUDNN_ACTIVATION_SOFTMAX, null, y_t[t]);
            }
        }
        ...
        public override void ResetParameters(bool resetAlsoOptimizerWeights = true)
        {
            ...
            Weights_ay.RandomMatrixNormalDistribution(Rand, 0.0 /* mean */, Math.Sqrt(2.0 / prevLayerNX) /*stdDev*/);
            Bias_a?.ZeroMemory();
            Bias_y?.ZeroMemory();
        }
        #endregion
