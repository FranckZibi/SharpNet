...
namespace SharpNet.Layers
{
    ...
    {
        #region constructor
        public SimpleRnnLayerGPU(int units, bool returnSequences, bool isBidirectional, bool trainable, Network network, string layerName) : 
            base(units, cudnnRNNMode_t.CUDNN_RNN_TANH, cudnnRNNBiasMode_t.CUDNN_RNN_SINGLE_INP_BIAS, returnSequences, isBidirectional, trainable, network, layerName)
        {
        }
        #endregion
