...
public abstract class DelegatedDatasetSample : AbstractDatasetSample
{
    ...
    public override void SavePredictionsInTargetFormat(DataFrame encodedPredictionsInTargetFormat, DataSet xDataset, string path) => EmbeddedDatasetSample.SavePredictionsInTargetFormat(encodedPredictionsInTargetFormat, xDataset, path);
