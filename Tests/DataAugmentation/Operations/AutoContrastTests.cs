...
namespace SharpNetTests.DataAugmentation.Operations
{
    ...
    public class AutoContrastTests
    {
        ...
        public void TestAutoContrast()
        {
            ...
            OperationTests.Check(new AutoContrast(pixelThresholdByChannel, null), input, inputShape, expected, null, ImageDataGenerator.FillModeEnum.Nearest);
            ...
            OperationTests.Check(new AutoContrast(pixelThresholdByChannel, meanAndVolatilityForEachChannel), input, inputShape, expected, null, ImageDataGenerator.FillModeEnum.Nearest);
        }
    }
}