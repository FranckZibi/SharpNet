...
namespace SharpNetTests.NonReg
{
    ...
    public class ParallelRunWithPyTorch
    {
        ...
        private static (float loss_before, float loss_after) Train(Network model, CpuTensor<float> X, CpuTensor<float> Y)
        {
            ...
            if (model.Sample.nesterov)
            {
                Log.Info("C# nesterov = " + model.Sample.nesterov);
            }
            Log.Info("C# batch_size= " + model.Sample.BatchSize);
            Log.Info("C# weight_decay= " + model.Sample.weight_decay);
        ...
        public void TestParallelRunWithPyTorch_Mse_AdamW()
        {
            ...
            var sample = new NetworkSample
            {
                ...
                .WithAdamW(lr:1,0.9, 0.999, 1e-8, 0.1);
            ...
            TestNetworkPropagation.FromNumpyArray("[[-0.007486820220947266], [0.5364435911178589]]").CopyTo(((Linear)model.Layers[1]).Weights);
            //TestNetworkPropagation.FromNumpyArray("[[-0.11299018561840057, -0.07257714122533798, 0.06053619086742401, 0.13839800655841827, -0.034300029277801514, 0.12471862137317657, -0.026863887906074524, 0.017635688185691833, 0.15091271698474884, -0.154611736536026, -0.10492299497127533, -0.04219420999288559, -0.06496666371822357, 0.1440001279115677, -0.10802994668483734, -0.0767221450805664, -0.11644008010625839, -0.1560935080051422, -0.09729008376598358, 0.14326633512973785, 0.07436972856521606, 0.08077876269817352, 0.008765265345573425, -0.08544725179672241, 0.028197452425956726, -0.15561579167842865, -0.12042771279811859, -0.08592166751623154, 0.1051563173532486, 0.09772022068500519, -0.07391583919525146, -0.006013736128807068, 0.10659344494342804, 0.16568885743618011, 0.06614702939987183, 0.022515475749969482], [0.11174772679805756, -0.09813372790813446, 0.031057342886924744, -0.12921759486198425, -0.1155143603682518, -0.08609726279973984, 0.07541216909885406, 0.06702673435211182, -0.09872542321681976, 0.05035118758678436, 0.09149535000324249, -0.021036222577095032, 0.006363585591316223, 0.03861744701862335, 0.10339610278606415, 0.16003234684467316, -0.12843726575374603, -0.06107829511165619, 0.06550164520740509, 0.138091579079628, 0.1450345665216446, 0.14705945551395416, 0.03316909074783325, -0.14493045210838318, 0.015332087874412537, -0.10426755994558334, -0.15532569587230682, 0.14808209240436554, 0.1267266422510147, -0.1662546694278717, 0.031195342540740967, -0.028076663613319397, -0.02742685377597809, -0.07629281282424927, 0.06409269571304321, -0.09871725738048553], [0.06109856069087982, 0.08428467810153961, 0.11931194365024567, 0.06231851875782013, -0.16495588421821594, -0.10811614990234375, 0.08321917057037354, 0.03488355875015259, -0.13001400232315063, -0.09596991539001465, 0.156791552901268, 0.11230297386646271, -0.07267086207866669, -0.04194746911525726, -0.15876635909080505, -0.0029956847429275513, -0.1255098283290863, -0.12855945527553558, -0.00918327271938324, 0.0250241756439209, -0.06825505197048187, 0.09889627993106842, -0.10142318904399872, 0.15122835338115692, 0.1142166405916214, -0.14054715633392334, -0.04148072004318237, 0.007520437240600586, 0.024316847324371338, 0.039529040455818176, 0.06540471315383911, 0.009983360767364502, -0.08132146298885345, 0.07886482775211334, -0.159874826669693, -0.0987844467163086]]").CopyTo(((Linear)model.Layers[3]).Weights);
        ...
        public void TestReluActivation_NCHW_2_1_4_4()
        {
            ...
            TestNetworkPropagation.FromNumpyArray("[[-0.0018717050552368164, 0.13411089777946472, -0.20576128363609314, -0.18398475646972656, -0.09628859162330627, 0.06703934073448181, -0.004953294992446899, 0.19822236895561218, -0.02218601107597351, 0.0661531388759613, -0.07555326819419861, -0.04914134740829468, -0.2388371229171753, -0.16557052731513977, -0.10305577516555786, 0.009260892868041992], [0.09883379936218262, 0.15000569820404053, -0.16948527097702026, -0.10886570811271667, 0.09080427885055542, 0.20759698748588562, -0.05145004391670227, 0.18707793951034546, -0.04029583930969238, 0.026453524827957153, 0.22636905312538147, -0.2319175899028778, -0.1573844850063324, -0.06329131126403809, -0.09744998812675476, 0.21600019931793213], [-0.16204491257667542, -0.11508321762084961, -0.1746601164340973, -0.23414024710655212, -0.14593511819839478, 0.21489951014518738, 0.1115545928478241, 0.12116813659667969, 0.013147890567779541, -0.12817087769508362, 0.04229617118835449, -0.23342368006706238, -0.1806415617465973, -0.128882497549057, 0.1577344834804535, 0.146580308675766]]").CopyTo(((Linear)model.Layers[2]).Weights);
            TestNetworkPropagation.FromNumpyArray("[[0.5739630460739136, 0.229140043258667, 0.0779958963394165], [0.38710546493530273, -0.3399451971054077, 0.10758578777313232], [-0.4476228356361389, -0.4001534581184387, -0.29824966192245483]]").CopyTo(((Linear)model.Layers[4]).Weights);
        ...
        public void TestParallelRunWithPyTorch_Convolution_AdamW()
        {
            ...
            var sample = new NetworkSample
            {
                ...
                ResourceIds = new List<int> { deviceId }
                    ...
                    .WithAdamW(lr:0.01, 0.9, 0.999, 1e-8, 0.005);
        ...
        public void Test_Convolution_With_Asymmetric_Padding()
        {
            ...
            TestNetworkPropagation.FromNumpyArray("[[-0.37871986627578735, -0.25700777769088745, -0.10335427522659302, -0.15913516283035278, 0.35272687673568726, -0.26461824774742126], [-0.18793010711669922, -0.2852187752723694, -0.38234943151474, -0.2383110523223877, 0.3509294390678406, 0.1821678876876831]]").CopyTo(((Linear)model.Layers[3]).Weights);
        ...
        public void TestParallelRunWithPyTorch_Conv1D()
        {
            ...
            model.Input(X.Shape[1], X.Shape[2], -1)
                .Conv1D(2, 3, 1, ConvolutionLayer.PADDING_TYPE.SAME, true)
                .Conv1D(2, 3, 2, ConvolutionLayer.PADDING_TYPE.VALID, true)
                .Flatten()
                .Linear(Y.Shape[1], true, true)
                .Activation(cudnnActivationMode_t.CUDNN_ACTIVATION_SOFTMAX);
        ...
        public void TestResNet_Shortcut_Different_Dimension_With_Conv_1x1_to_change_Dimension_NCHW_2_1_4_4()
        {
            ...
            model
                ...
                .Convolution(1, 1, 1, ConvolutionLayer.PADDING_TYPE.VALID, true, 1) //right (identity shortcut)
                .AddLayer(3, 2)
                .Flatten()
                .Linear(Y.Shape[1], true, true)
                .Activation(cudnnActivationMode_t.CUDNN_ACTIVATION_SOFTMAX)
        ...
        [Test, Explicit]
        public void Test_weight_decay_ConvolutionLayer_SGDVanilla_NCHW_2_1_4_4()
        {
            const int rows = 2;
            ...
            .WithSGD(0.1, 0.6, 0.9, false);

            var model = new Network(sample, null, GetDefaultWorkingDirectory(), nameof(Test_weight_decay_ConvolutionLayer_SGDVanilla_NCHW_2_1_4_4), false);
        ...
        public void Test_DotProductAttention(bool is_causal, double expected_loss_before, double expected_loss_after)
        {
            ...
            model
                ...
                .Conv1D(2, 1, 1, ConvolutionLayer.PADDING_TYPE.SAME, true, 0, "conv1D_Q")
                .Conv1D(2, 1, 1, ConvolutionLayer.PADDING_TYPE.SAME, true, 0, "conv1D_K")
                .Conv1D(2, 1, 1, ConvolutionLayer.PADDING_TYPE.SAME, true, 0, "conv1D_V")
        ...
        [Test, Explicit]
        public void TestParallelRunWithPyTorch_Embedding()
        {
            const double momentum = 0.9;
            ...
            const int deviceId = -1;
            //var deviceId = 0;
            var model = TestNetwork.NewForTests(
                        new NetworkSample
                        {
                            LossFunction = EvaluationMetricEnum.BinaryCrossentropy,
                            ShuffleDatasetBeforeEachEpoch = false,
            ...
            Debug.Assert(model.Layers.Count == 0);
            model
            ...
            TestNetworkPropagation.FromNumpyArray("[[1.5409960746765137, -0.293428897857666, -2.1787893772125244, 0.5684312582015991, -1.0845223665237427], [-1.3985954523086548, 0.40334683656692505, 0.8380263447761536, -0.7192575931549072, -0.40334352850914], [-0.5966353416442871, 0.18203648924827576, -0.8566746115684509, 1.1006041765213013, -1.0711873769760132]]")
                .CopyTo(((EmbeddingLayer)model.Layers[1]).Weights);
            TestNetworkPropagation.FromNumpyArray("[[0.07221019268035889, 0.35839003324508667, -0.3147280812263489, 0.09960508346557617, -0.41441822052001953, -0.3704701066017151, -0.2761255204677582, 0.24185699224472046, 0.21496379375457764, -0.316625714302063, 0.1614830493927002, 0.2934378981590271, -0.06746602058410645, 0.02040886878967285, 0.12385135889053345, 0.3316052556037903, 0.5132452845573425, -0.4119156002998352, -0.19588631391525269, 0.21007263660430908]]")
                .CopyTo(((Linear)model.Layers[3]).Weights);

            (float loss_before, float loss_after) = Train(model, X, Y);

            Assert.AreEqual(0.9666134119033813, loss_before, 1e-6);
            Assert.AreEqual(0.049854833632707596, loss_after, 1e-6);
            //test_save_sharpnet(model, X);
        }

        [Test, Explicit]
        public void TestParallelRunWithPyTorch_Embedding_GlobalPooling()
        {
            const int deviceId = -1;
            const int num_embeddings = 3;
            const int embedding_dim = 5;
            ...
            var model = TestNetwork.NewForTests(
                       ...
                       .WithAdam(lr:0.01,0.9, 0.999, 1e-7, weight_decay: 0.00),
                        NetworkSample.DefaultWorkingDirectory,
                        "Embedding_GlobalPooling"
                );

            model.Input(maxWordsBySentence, -1, -1)
                .Embedding(num_embeddings, embedding_dim)
                .GlobalAvgPooling()
            ...
            TestNetworkPropagation.FromNumpyArray("[[1.5409960746765137, -0.293428897857666, -2.1787893772125244, 0.5684312582015991, -1.0845223665237427], [-1.3985954523086548, 0.40334683656692505, 0.8380263447761536, -0.7192575931549072, -0.40334352850914], [-0.5966353416442871, 0.18203648924827576, -0.8566746115684509, 1.1006041765213013, -1.0711873769760132]]")
                .CopyTo(((EmbeddingLayer)model.Layers[1]).Weights);
            TestNetworkPropagation.FromNumpyArray("[[0.05761122703552246], [-0.5616166591644287], [0.1853325366973877], [-1.0228114128112793]]")
                .CopyTo(((Linear)model.Layers[3]).Weights);
            TestNetworkPropagation.FromNumpyArray("[[-0.03952622413635254, 0.700603723526001, 1.0890183448791504, 0.43476271629333496]]")
                .CopyTo(((Linear)model.Layers[5]).Weights);
            

            (float loss_before, float loss_after) = Train(model, X, Y);

            Assert.AreEqual(0.6975281238555908, loss_before, 1e-6);
            Assert.AreEqual(0.6616119146347046, loss_after, 1e-6);
            //test_save_sharpnet(model, X);
        }

        [Test, Explicit]
        public void Test_efficientnet()
        {
            var model_efficientnet_b0_pytorch = Network.LoadTrainedNetworkModel("C:/Projects/SharpNet/Tests/NonReg", "model_efficientnet_b0");
            model_efficientnet_b0_pytorch.Save("C:/Projects/SharpNet/Tests/NonReg", model_efficientnet_b0_pytorch.ModelName + "_loaded");

            var batch_size = 3;
            var X = TestNetworkPropagation.numpy_array_for_tests(batch_size, 3, 224, 224);
            var Y = TestNetworkPropagation.y_numpy_array_for_tests(batch_size, 1000);
            Log.Info($"PyTorch Y_pref_after: {model_efficientnet_b0_pytorch.Predict(X, false).ToNumpy()}");
            var model_efficientnet_b0_sharpnet = Network.LoadTrainedNetworkModel("C:/Projects/SharpNet/Tests/NonReg", model_efficientnet_b0_pytorch.ModelName);
            model_efficientnet_b0_sharpnet.Save("C:/Projects/SharpNet/Tests/NonReg", model_efficientnet_b0_pytorch.ModelName + "_loaded");
            Log.Info($"SharpNet (reloaded) Y_pref_after: {model_efficientnet_b0_sharpnet.Predict(X, false).ToNumpy()}");
        }
