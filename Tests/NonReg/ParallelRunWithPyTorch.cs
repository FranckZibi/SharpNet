...
namespace SharpNetTests.NonReg
{
    ...
    public class ParallelRunWithPyTorch
    {
        ...
        public void TestParallelRunWithPyTorch_Mse()
        {
            ...
            TestNetworkPropagation.FromNumpyArray("[[-0.0033482015132904053, 0.23990488052368164, -0.36807698011398315, -0.3291219472885132, -0.1722462773323059], [0.11992359161376953, -0.008860737085342407, 0.3545909523963928, -0.039687544107437134, 0.11833834648132324], [-0.13515380024909973, -0.08790671825408936, -0.4272448420524597, -0.2961815595626831, -0.18435177206993103]]").CopyTo(((DenseLayer)model.Layers[1]).Weights);
        ...
        public void TestParallelRunWithPyTorch_Mse_AdamW()
        {
            ...
            TestNetworkPropagation.FromNumpyArray("[[-0.007486820220947266], [0.5364435911178589]]").CopyTo(((DenseLayer)model.Layers[1]).Weights);
            //TestNetworkPropagation.FromNumpyArray("[[-0.11299018561840057, -0.07257714122533798, 0.06053619086742401, 0.13839800655841827, -0.034300029277801514, 0.12471862137317657, -0.026863887906074524, 0.017635688185691833, 0.15091271698474884, -0.154611736536026, -0.10492299497127533, -0.04219420999288559, -0.06496666371822357, 0.1440001279115677, -0.10802994668483734, -0.0767221450805664, -0.11644008010625839, -0.1560935080051422, -0.09729008376598358, 0.14326633512973785, 0.07436972856521606, 0.08077876269817352, 0.008765265345573425, -0.08544725179672241, 0.028197452425956726, -0.15561579167842865, -0.12042771279811859, -0.08592166751623154, 0.1051563173532486, 0.09772022068500519, -0.07391583919525146, -0.006013736128807068, 0.10659344494342804, 0.16568885743618011, 0.06614702939987183, 0.022515475749969482], [0.11174772679805756, -0.09813372790813446, 0.031057342886924744, -0.12921759486198425, -0.1155143603682518, -0.08609726279973984, 0.07541216909885406, 0.06702673435211182, -0.09872542321681976, 0.05035118758678436, 0.09149535000324249, -0.021036222577095032, 0.006363585591316223, 0.03861744701862335, 0.10339610278606415, 0.16003234684467316, -0.12843726575374603, -0.06107829511165619, 0.06550164520740509, 0.138091579079628, 0.1450345665216446, 0.14705945551395416, 0.03316909074783325, -0.14493045210838318, 0.015332087874412537, -0.10426755994558334, -0.15532569587230682, 0.14808209240436554, 0.1267266422510147, -0.1662546694278717, 0.031195342540740967, -0.028076663613319397, -0.02742685377597809, -0.07629281282424927, 0.06409269571304321, -0.09871725738048553], [0.06109856069087982, 0.08428467810153961, 0.11931194365024567, 0.06231851875782013, -0.16495588421821594, -0.10811614990234375, 0.08321917057037354, 0.03488355875015259, -0.13001400232315063, -0.09596991539001465, 0.156791552901268, 0.11230297386646271, -0.07267086207866669, -0.04194746911525726, -0.15876635909080505, -0.0029956847429275513, -0.1255098283290863, -0.12855945527553558, -0.00918327271938324, 0.0250241756439209, -0.06825505197048187, 0.09889627993106842, -0.10142318904399872, 0.15122835338115692, 0.1142166405916214, -0.14054715633392334, -0.04148072004318237, 0.007520437240600586, 0.024316847324371338, 0.039529040455818176, 0.06540471315383911, 0.009983360767364502, -0.08132146298885345, 0.07886482775211334, -0.159874826669693, -0.0987844467163086]]").CopyTo(((DenseLayer)model.Layers[3]).Weights);

            (float loss_before, float loss_after) = Train(model, X, Y);
            Assert.AreEqual(0.6364270448684692, loss_before, 1e-6);
            Assert.AreEqual(1.6577095985412598, loss_after, 1e-6); //1.6577413082122803d , 1.6577074527740479d
        }
        ...
        public void TestReluActivation_NCHW_2_1_4_4()
        {
            ...
            model
                .Input(X.Shape[1], X.Shape[2], X.Shape[3]).Dense(3, sample.lambdaL2Regularization, false)
                .Activation(cudnnActivationMode_t.CUDNN_ACTIVATION_RELU)
                .Dense(Y.Shape[1], sample.lambdaL2Regularization, false)
                .Activation(cudnnActivationMode_t.CUDNN_ACTIVATION_SIGMOID);
            TestNetworkPropagation.FromNumpyArray("[[-0.0018717050552368164, 0.13411089777946472, -0.20576128363609314, -0.18398475646972656, -0.09628859162330627, 0.06703934073448181, -0.004953294992446899, 0.19822236895561218, -0.02218601107597351, 0.0661531388759613, -0.07555326819419861, -0.04914134740829468, -0.2388371229171753, -0.16557052731513977, -0.10305577516555786, 0.009260892868041992], [0.09883379936218262, 0.15000569820404053, -0.16948527097702026, -0.10886570811271667, 0.09080427885055542, 0.20759698748588562, -0.05145004391670227, 0.18707793951034546, -0.04029583930969238, 0.026453524827957153, 0.22636905312538147, -0.2319175899028778, -0.1573844850063324, -0.06329131126403809, -0.09744998812675476, 0.21600019931793213], [-0.16204491257667542, -0.11508321762084961, -0.1746601164340973, -0.23414024710655212, -0.14593511819839478, 0.21489951014518738, 0.1115545928478241, 0.12116813659667969, 0.013147890567779541, -0.12817087769508362, 0.04229617118835449, -0.23342368006706238, -0.1806415617465973, -0.128882497549057, 0.1577344834804535, 0.146580308675766]]").CopyTo(((DenseLayer)model.Layers[1]).Weights);
            TestNetworkPropagation.FromNumpyArray("[[0.5739630460739136, 0.229140043258667, 0.0779958963394165], [0.38710546493530273, -0.3399451971054077, 0.10758578777313232], [-0.4476228356361389, -0.4001534581184387, -0.29824966192245483]]").CopyTo(((DenseLayer)model.Layers[3]).Weights);
        ...
        public void TestParallelRunWithPyTorch_Convolution_AdamW()
        {
            ...
            Assert.AreEqual(0.6931346654891968, loss_before, 1e-6);
            Assert.AreEqual(0.6222155690193176, loss_after, 1e-6);
        }
        ...
        public void Test_Convolution_With_Asymmetric_Padding()
        {
            ...
            TestNetworkPropagation.FromNumpyArray("[[-0.37871986627578735, -0.25700777769088745, -0.10335427522659302, -0.15913516283035278, 0.35272687673568726, -0.26461824774742126], [-0.18793010711669922, -0.2852187752723694, -0.38234943151474, -0.2383110523223877, 0.3509294390678406, 0.1821678876876831]]").CopyTo(((DenseLayer)model.Layers[3]).Weights);

            (float loss_before, float loss_after) = Train(model, X, Y);

            Assert.AreEqual(0.6809013485908508, loss_before, 1e-4);
            Assert.AreEqual(0.45677560567855835, loss_after, 1e-4);
        }
        ...
        public void TestParallelRunWithPyTorch_Conv1D()
        {
            ...
            model.Input(X.Shape[1], X.Shape[2], -1)
                ...
                .Flatten().Dense(Y.Shape[1], sample.lambdaL2Regularization, false)
                .Activation(cudnnActivationMode_t.CUDNN_ACTIVATION_SOFTMAX);
        ...
        public void TestParallelRunWithPyTorch_LayerNormalizationNchw()
        {
            ...
            Assert.AreEqual(0.5169235467910767, loss_after, 1e-6);
        }
        ...
        public void TestParallelRunWithPyTorch_BatchNormalizationNchw2345()
        {
            ...
            Assert.AreEqual(0.25887892544269564, loss_before, 1e-6);
            Assert.AreEqual(0.03555814176797867, loss_after, 1e-3);
        }
        ...
        public void TestResNet_Shortcut_Same_Dimension_NCHW_2_1_4_4()
        {
            ...
            TestNetworkPropagation.FromNumpyArray("[[-0.09628859162330627, 0.06703934073448181, -0.004953294992446899, 0.19822236895561218, -0.02218601107597351, 0.0661531388759613, -0.07555326819419861, -0.04914134740829468, -0.2388371229171753, -0.16557052731513977, -0.10305577516555786, 0.009260892868041992, 0.09883379936218262, 0.15000569820404053, -0.16948527097702026, -0.10886570811271667], [0.09080427885055542, 0.20759698748588562, -0.05145004391670227, 0.18707793951034546, -0.04029583930969238, 0.026453524827957153, 0.22636905312538147, -0.2319175899028778, -0.1573844850063324, -0.06329131126403809, -0.09744998812675476, 0.21600019931793213, -0.16204491257667542, -0.11508321762084961, -0.1746601164340973, -0.23414024710655212], [-0.14593511819839478, 0.21489951014518738, 0.1115545928478241, 0.12116813659667969, 0.013147890567779541, -0.12817087769508362, 0.04229617118835449, -0.23342368006706238, -0.1806415617465973, -0.128882497549057, 0.1577344834804535, 0.146580308675766, -0.1108737587928772, -0.009020596742630005, 0.15989017486572266, 0.24853327870368958]]").CopyTo(model.Layers[4].Weights);
        ...
        public void TestResNet_Shortcut_Different_Dimension_With_Conv_1x1_to_change_Dimension_NCHW_2_1_4_4()
        {
            ...
            model
                ...
                .AddLayer(3, 2).Dense(Y.Shape[1], 0.0, false)
                .Activation(cudnnActivationMode_t.CUDNN_ACTIVATION_SOFTMAX)
                ;
        ...
        public void TestL2Regularization_ConvolutionLayer_SGDVanilla_NCHW_2_1_4_4()
        {
            ...
            TestNetworkPropagation.FromNumpyArray("[[[[-0.007486820220947266]]]]").CopyTo(model.Layers[1].Weights);
            TestNetworkPropagation.FromNumpyArray("[[-0.20576128363609314, -0.18398475646972656, -0.09628859162330627, 0.06703934073448181, -0.004953294992446899, 0.19822236895561218, -0.02218601107597351, 0.0661531388759613, -0.07555326819419861, -0.04914134740829468, -0.2388371229171753, -0.16557052731513977, -0.10305577516555786, 0.009260892868041992, 0.09883379936218262, 0.15000569820404053], [-0.16948527097702026, -0.10886570811271667, 0.09080427885055542, 0.20759698748588562, -0.05145004391670227, 0.18707793951034546, -0.04029583930969238, 0.026453524827957153, 0.22636905312538147, -0.2319175899028778, -0.1573844850063324, -0.06329131126403809, -0.09744998812675476, 0.21600019931793213, -0.16204491257667542, -0.11508321762084961], [-0.1746601164340973, -0.23414024710655212, -0.14593511819839478, 0.21489951014518738, 0.1115545928478241, 0.12116813659667969, 0.013147890567779541, -0.12817087769508362, 0.04229617118835449, -0.23342368006706238, -0.1806415617465973, -0.128882497549057, 0.1577344834804535, 0.146580308675766, -0.1108737587928772, -0.009020596742630005]]").CopyTo(model.Layers[2].Weights);
        ...
        public void Test_Huber()
        {
            ...
            model
                .Input(X.Shape[1], X.Shape[2], X.Shape[3])
                .Dense(3, sample.lambdaL2Regularization, false)
                .Activation(cudnnActivationMode_t.CUDNN_ACTIVATION_RELU)
                .Dense(1, sample.lambdaL2Regularization, false)
                ;

            TestNetworkPropagation.FromNumpyArray("[[-0.002161264419555664, 0.15485793352127075, -0.2375926673412323, -0.21244728565216064, -0.1111844927072525, 0.07741037011146545, -0.005719572305679321, 0.22888749837875366, -0.02561819553375244, 0.07638707756996155, -0.08724139630794525, -0.05674353241920471], [-0.275785356760025, -0.1911843717098236, -0.11899855732917786, 0.010693550109863281, 0.11412343382835388, 0.17321166396141052, -0.19570472836494446, -0.12570728361606598, 0.10485175251960754, 0.23971235752105713, -0.05940939486026764, 0.21601897478103638], [-0.046529620885849, 0.03054589033126831, 0.26138848066329956, -0.2677953541278839, -0.1817319393157959, -0.07308250665664673, -0.11252555251121521, 0.24941551685333252, -0.18711334466934204, -0.13288664817810059, -0.20168012380599976, -0.27036187052726746]]").CopyTo(model.Layers[1].Weights);
            TestNetworkPropagation.FromNumpyArray("[[0.2798258066177368, 0.030363738536834717, -0.2959979474544525]]").CopyTo(model.Layers[3].Weights);
        ...
        public void TestLeakyReluActivation_NCHW_10_1_4_4()
        {
            ...
            TestNetworkPropagation.FromNumpyArray("[[-0.0018717050552368164, 0.13411089777946472, -0.20576128363609314, -0.18398475646972656, -0.09628859162330627, 0.06703934073448181, -0.004953294992446899, 0.19822236895561218, -0.02218601107597351, 0.0661531388759613, -0.07555326819419861, -0.04914134740829468, -0.2388371229171753, -0.16557052731513977, -0.10305577516555786, 0.009260892868041992], [0.09883379936218262, 0.15000569820404053, -0.16948527097702026, -0.10886570811271667, 0.09080427885055542, 0.20759698748588562, -0.05145004391670227, 0.18707793951034546, -0.04029583930969238, 0.026453524827957153, 0.22636905312538147, -0.2319175899028778, -0.1573844850063324, -0.06329131126403809, -0.09744998812675476, 0.21600019931793213], [-0.16204491257667542, -0.11508321762084961, -0.1746601164340973, -0.23414024710655212, -0.14593511819839478, 0.21489951014518738, 0.1115545928478241, 0.12116813659667969, 0.013147890567779541, -0.12817087769508362, 0.04229617118835449, -0.23342368006706238, -0.1806415617465973, -0.128882497549057, 0.1577344834804535, 0.146580308675766]]").CopyTo(model.Layers[1].Weights);
            TestNetworkPropagation.FromNumpyArray("[[0.5739630460739136, 0.229140043258667, 0.0779958963394165], [0.38710546493530273, -0.3399451971054077, 0.10758578777313232], [-0.4476228356361389, -0.4001534581184387, -0.29824966192245483]]").CopyTo(model.Layers[3].Weights);
        ...
        public void Test_SimpleRNN()
        {
            ...
            TestNetworkPropagation.FromNumpyArray("[[-0.5819807648658752, -0.5203874707221985], [-0.27234524488449097, 0.1896159052848816]]").CopyTo(((RecurrentLayer)model.Layers[1])._weights_hh[0]);
            TestNetworkPropagation.FromNumpyArray("[[-0.6755334138870239, -0.4683041572570801], [-0.2914857566356659, 0.026193737983703613]]").CopyTo(((RecurrentLayer)model.Layers[1])._weights_hh[1]);
            TestNetworkPropagation.FromNumpyArray("[[-0.4451505243778229, -0.17901486158370972], [-0.2756301760673523, 0.6109407544136047]]").CopyTo(((RecurrentLayer)model.Layers[1])._weights_hh[2]);
            TestNetworkPropagation.FromNumpyArray("[[-0.5109314918518066, -0.36453473567962646], [0.44614046812057495, 0.4145917296409607]]").CopyTo(((RecurrentLayer)model.Layers[1])._weights_hh[3]);
            ...
            TestNetworkPropagation.FromNumpyArray("[[0.3199467062950134, 0.2843703627586365], [-0.4188564717769623, 0.21362197399139404]]").CopyTo(((RecurrentLayer)model.Layers[2])._weights_hh[0]);
