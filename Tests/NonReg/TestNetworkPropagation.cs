...
namespace SharpNetTests.NonReg
{
    ...
    public class TestNetworkPropagation
    {
        ...
        public void TestSigmoidActivation_NCHW_1_1_1_1(List<int> resourceIds)
        {
            ...
            w.CopyTo(((LinearLayer)network.Layers[1]).Weights);
            ...
            TestNetwork.Fit(network, X, Y, learningRate, num_epochs, X.Shape[0]);
        ...
        public void TestSigmoidActivation_NCHW_2_1_4_4(List<int> resourceIds)
        {
            ...
            var network = GetNetwork(EvaluationMetricEnum.BinaryCrossentropy, resourceIds);
            network
                .Input(X.Shape[1], X.Shape[2], X.Shape[3]).Linear(Y.Shape[1], true, 0.0, false)
                .Activation(cudnnActivationMode_t.CUDNN_ACTIVATION_SIGMOID);
        ...
        public void TestReluActivation_NCHW_2_1_4_4(List<int> resourceIds)
        {
            ...
            var network = GetNetwork(EvaluationMetricEnum.BinaryCrossentropy, resourceIds);
            network
                .Input(X.Shape[1], X.Shape[2], X.Shape[3]).Linear(3, true, 0.0, false)
                .Activation(cudnnActivationMode_t.CUDNN_ACTIVATION_RELU).Linear(Y.Shape[1], true, 0.0, false)
                .Activation(cudnnActivationMode_t.CUDNN_ACTIVATION_SIGMOID);
            ...
            w.CopyTo(((LinearLayer)network.Layers[3]).Weights);
        ...
        public void TestLeakyReluActivation_NCHW_2_1_4_4(List<int> resourceIds)
        {
            ...
            network
                ...
                .Activation(cudnnActivationMode_t.CUDNN_ACTIVATION_LEAKY_RELU, Tensor.SingleFloat(0.1f)).Linear(Y.Shape[1], true, 0.0, false)
                .Activation(cudnnActivationMode_t.CUDNN_ACTIVATION_SIGMOID);
        ...
        public void TestConvolutionWithReluActivation_NCHW_2_1_4_4(List<int> resourceIds)
        {
            ...
            network
                .Input(X.Shape[1], X.Shape[2], X.Shape[3])
                .Convolution(3, 3, 1, ConvolutionLayer.PADDING_TYPE.SAME, 0.0, true).Linear(Y.Shape[1], true, 0.0, false)
                .Activation(cudnnActivationMode_t.CUDNN_ACTIVATION_SIGMOID);
        ...
        public void TestBatchNormalization_NCHW_2_1_4_4(List<int> resourceIds)
        {
            ...
            network
                .Input(X.Shape[1], X.Shape[2], X.Shape[3])
                .Flatten()
                .BatchNorm(0.99, 1e-5, "BatchNorm").Linear(Y.Shape[1], true, 0.0, false)
                .Activation(cudnnActivationMode_t.CUDNN_ACTIVATION_SIGMOID);
        ...
        public void TestBatchNormalizationNchw2345(List<int> resourceIds)
        {
            ...
            network
                ...
                .Flatten()
                .Linear(Y.Shape[1], true, 0.00, false)
                .Activation(cudnnActivationMode_t.CUDNN_ACTIVATION_SOFTMAX);
        ...
        public void TestLayerNormalizationNchw2345(List<int> resourceIds)
        {
            ...
            TestNetworkPropagation.FromNumpyArray("[[0.07255405187606812, -0.3649131655693054], [0.47779881954193115, 0.36304938793182373], [0.19000232219696045, 0.039753496646881104], [-0.6357459425926208, 0.489038348197937], [-0.03964346647262573, -0.1483067274093628], [0.5055941343307495, 0.17909908294677734], [-0.65219646692276, 0.46842241287231445], [-0.5134063959121704, 0.602361798286438], [-0.3778911828994751, 0.21278679370880127], [-0.4962396025657654, -0.45931848883628845], [0.6377934217453003, 0.45122671127319336], [-0.5726242065429688, 0.20566171407699585]]").CopyTo(((LinearLayer)network.Layers[4]).Weights);
        ...
        public void Test_ScaledDotProductAttention(List<int> resourceIds)
        {
            ...
            network.Flatten()
                .Linear(Y.Shape[1], true, lambdaL2Regularization, false)
                .Activation(cudnnActivationMode_t.CUDNN_ACTIVATION_SOFTMAX);
        ...
        public void TestResNet_Shortcut_Same_Dimension_NCHW_2_1_4_4(List<int> resourceIds)
        {
            ...
            network
                ...
                .Convolution(1, 1, 1, ConvolutionLayer.PADDING_TYPE.VALID, 0.0, true)
                .AddLayer(2, 1).Linear(Y.Shape[1], true, 0.0, false)
                .Activation(cudnnActivationMode_t.CUDNN_ACTIVATION_SOFTMAX);
            ...
            w.CopyTo(((LinearLayer)network.Layers[4]).Weights);
        ...
        public void TestResNet_Shortcut_Different_Dimension_With_Conv_1x1_to_change_Dimension_NCHW_2_1_4_4(List<int> resourceIds)
        {
            ...
            network.AddLayer(3, 2).Linear(Y.Shape[1], true, 0.0, false)
                .Activation(cudnnActivationMode_t.CUDNN_ACTIVATION_SOFTMAX)
                ;
            Tensor w = FromNumpyArray("[[[[-0.7714059]]]]");
            w.CopyTo(((ConvolutionLayer)network.Layers[1]).Weights);
            ...
            w.CopyTo(((LinearLayer)network.Layers[5]).Weights);
        ...
        public void TestL2Regularization_ConvolutionLayer_SGDVanilla_NCHW_2_1_4_4(List<int> resourceIds)
        {
            ...
            var network = GetNetwork(EvaluationMetricEnum.CategoricalCrossentropy, resourceIds)
                .Input(X.Shape[1], X.Shape[2], X.Shape[3])
                .Convolution(1, 1, 1, ConvolutionLayer.PADDING_TYPE.VALID, lambdaL2Regularization, true).Linear(Y.Shape[1], true, lambdaL2Regularization, false)
                .Activation(cudnnActivationMode_t.CUDNN_ACTIVATION_SOFTMAX);
        ...
        [Test, TestCaseSource(nameof(GetTestCases))]
        public void TestL2Regularization_LinearLayer_SGDVanilla_NCHW_2_1_4_4(List<int> resourceIds)
        {
            const int num_epochs = 10;
            const double learningRate = 0.12;
            const double lambdaL2Regularization = 0.05;
        ...
        [Test, TestCaseSource(nameof(GetTestCases))]
        public void TestL2Regularization_LinearLayer_SGDMomentum_NCHW_2_1_4_4(List<int> resourceIds)
        {
            const int num_epochs = 10;
            const double learningRate = 0.12;
        ...
        //[Test, TestCaseSource(nameof(GetTestCases))]
        //public void TestL2Regularization_LinearLayer_Adam_NCHW_2_1_4_4(List<int> resourceIds)
        //{
        //    const int num_epochs = 10;
        //    const double learningRate = 0.12;
        //    const double lambdaL2Regularization = 0.05;
        ...
        public void Test_Convolution_With_Asymmetric_Padding(List<int> resourceIds)
        {
            ...
            FromNumpyArray("[[0.28597003,  0.4547698],[-0.4759524,   0.7416852],[-0.85341465, -0.40610817],[-0.14299387, -0.7595345],[0.08673978, -0.36584526],[0.855876, -0.65572554]]").CopyTo(((LinearLayer)network.Layers[3]).Weights);
        ...
        public void Test_Convolution_With_Asymmetric_Padding_V2(List<int> resourceIds)
        {
            ...
            FromNumpyArray("[[ 0.1670317  , 0.6739995 ], [ 0.02281129 , 0.36221045], [ 0.7731834  , 0.41565734], [-0.2101801  , 0.21554786], [-0.1369173  , 0.44515973], [-0.18519688 , 0.5447338 ]]").CopyTo(((LinearLayer)network.Layers[4]).Weights);
